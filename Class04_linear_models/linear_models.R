...
### basic correlations
  ...
  cor.test(EquationCitations$equations, EquationCitations$mainequations) ### pearson by default
  cor.test(EquationCitations$equations, EquationCitations$mainequations, method="spearman") ### spearman (non-parametric)
  plot(EquationCitations)
...
### submit a single PDF/word doc with (A) A composite figure showing your result, (B) the output summary of your best model, (C) A few sentences describing your result, (D) your code
